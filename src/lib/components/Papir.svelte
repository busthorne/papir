<script lang="ts">
	...
	export let maxScroll = window.innerWidth * 0.7;
...
<div class="papir-container" class:opened={isOpen} use:handleSwipe on:mouseenter={handleMouseEnter} on:mouseleave={handleMouseLeave}>
...
<style lang="scss">	.papir-container {
	width: 100%;
	height: 100vh;
	overflow-x: hidden;
	overflow-y: scroll;
